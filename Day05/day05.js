...
// const readUserInput = (cmdSet, arr) => {
//     console.log('creating interface')
//     const io = nodeReadline.createInterface({ input: process.stdin, output: process.stdout })
//     console.log('asking the question')
//     io.question('Input (int) required: ', (answer) => {
//         io.resume()
//         arr[ cmdSet[1] ] = parseInt(answer)
//         io.close()
//     })
//     io.pause()
//     console.log('after the question has been asked')
// }
...
const runPart1 = async () => {
    ...
    while (idx < intcodeProg.length) {
        ...
        opdetail.async ? await opdetail.func(parts, intcodeProg) : opdetail.func(parts, intcodeProg)
        idx += opdetail.inc
    }
}
